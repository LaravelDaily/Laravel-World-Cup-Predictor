...
class Add5b2a2e3a4473bRelationshipsToPredictionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('predictions', function(Blueprint $table) {
            if(Schema::hasColumn('predictions', 'user_id')) {
                $table->dropForeign('174541_5b2a2e3492f29');
                $table->dropIndex('174541_5b2a2e3492f29');
                $table->dropColumn('user_id');
            }
            if(Schema::hasColumn('predictions', 'match_id')) {
                $table->dropForeign('174541_5b2a2e34aa7c2');
                $table->dropIndex('174541_5b2a2e34aa7c2');
